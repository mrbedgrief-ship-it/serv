...
setblock 0 80 -9 warped_sign[rotation=8]{front_text:{messages:['{"text":"OUTPOST BLACKLINE","color":"aqua","bold":true}','{"text":"Forge 1.20.1 local test","color":"gray"}','{"text":"Turn shaders OFF","color":"yellow"}','{"text":"Safe bunker start","color":"green"}']}}
setblock -9 80 12 warped_sign[rotation=0]{front_text:{messages:['{"text":"Briefing","color":"aqua","bold":true}','{"text":"1. Gear up here","color":"gray"}','{"text":"2. Press Zone Survival","color":"gray"}','{"text":"3. Return with loot","color":"gray"}']}}
